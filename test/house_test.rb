...
class HouseTest < Minitest::Test
  ...
  def test_line_5
    ...
    assert_equal expected, House.for(HouseVerse, 5)
  end
  ...
  def test_line_6
    ...
    assert_equal expected, House.for(HouseVerse, 6)
  end
  ...
  def test_line_7
    ...
    assert_equal expected, House.for(HouseVerse, 7)
  end
  ...
  def test_line_8
    ...
    assert_equal expected, House.for(HouseVerse, 8)
  end
  ...
  def test_line_12
    ...
    assert_equal expected, House.for(HouseVerse, 12)
  end
